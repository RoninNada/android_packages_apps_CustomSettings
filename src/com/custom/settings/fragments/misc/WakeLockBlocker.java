...
package com.custom.settings.fragments.misc;
...
public class WakeLockBlocker extends SettingsPreferenceFragment {
                ...
                .setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton v, boolean checked) {
                        ...
                        Settings.System.putIntForUser(getActivity().getContentResolver(),
                                ...
                                checked ? 1 : 0, UserHandle.USER_CURRENT);
    ...
    private boolean isFirstEnable() {
        return Settings.System.getString(getActivity().getContentResolver(),
                Settings.System.WAKELOCK_BLOCKING_LIST) == null;
    }

    private void updateSwitches() {
        mBlockerEnabled.setChecked(Settings.System.getIntForUser(getActivity().getContentResolver(),
                Settings.System.WAKELOCK_BLOCKING_ENABLED, 0, UserHandle.USER_CURRENT) == 1);
